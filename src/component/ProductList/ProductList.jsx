            ...
            <div className='detail_product'>
                <div className='detail_information'>
                    <div className='d-flex'>
                        <span>Tên : </span>
                        <span>POWER CUSHION 88 DIAL UNISEX</span>
                    </div>
                    <div className='d-flex'>
                        <span>Hãng sản xuất : </span>
                        <Select className='select-detail' placeholder="Yonex" style={{ width: 200 }}>
                            <Option value="option1">Tùy chọn 1</Option>
                        </Select>
                    </div>
                    <div className='d-flex'>
                        <span>Môn thể thao : </span>
                        <Select className='select-detail' placeholder="Cầu lông" style={{ width: 200 }}>
                            <Option value="option1">Tùy chọn 1</Option>
                        </Select>
                    </div>
                    <div className='d-flex'>
                        <span>Loại sản phẩm : </span>
                        <Select className='select-detail' placeholder="Giày" style={{ width: 200 }}>
                            <Option value="option1">Tùy chọn 1</Option>
                        </Select>
                    </div>
                </div>
                <div>
                    <img src="https://cdn.shopvnb.com/img/300x300/uploads/gallery/giay-cau-long-yonex-aerus-z2-wide-2024-dark-gray-chinh-hang_1724871228.webp" alt="Product" />
                </div>
            </div>
            <div style={{ marginTop: '20px' }}>
                <Table columns={columns} dataSource={products} rowKey="stt" />
            </div>
